...
var wrapTransactionCreator = function wrapTransactionCreator(transactionCreator) {
	return function (transactionParameters) {
		...
		var senderPublicKey = passphrase ? _crypto2.default.getKeys(passphrase).publicKey : null;
		...
		return passphrase ? (0, _prepareTransaction2.default)(transaction, passphrase, secondPassphrase) : transaction;
	};
}; /*
